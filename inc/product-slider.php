                                ...
                                <ul class="slides">
                                    <li class="col col-1-of-3 col-m-1-of-2">
                                        <a href="'.esc_url( home_url( '/' ) ).'">
                                            <img src="'.get_template_directory_uri().'/images/gallery/men1.jpg" alt="'.__('men','flat-commerce').'"/>
                                            <div class="product-item-wrapper">
                                                <div class="total">
                                                    <a href="#">
                                                        '.__( '24 Collections', 'flat-commerce' ).'
                                                    </a>
                                                </div>
                                                <div class="type-of-product">
                                                    '.__( 'hiking and adventure', 'flat-commerce' ).'
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="col col-1-of-3 col-m-1-of-2">
                                        <a href="'.esc_url( home_url( '/' ) ).'">
                                            <img src="'.get_template_directory_uri().'/images/gallery/men2.png" alt="'.__('men','flat-commerce').'"/>
                                            <div class="product-item-wrapper">
                                                <div class="total">
                                                    <a href="#">
                                                        '.__( '52 Collections', 'flat-commerce' ).'
                                                    </a>
                                                </div>
                                                <div class="type-of-product">
                                                    '.__( 'Party wear clothes', 'flat-commerce' ).'
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <li class="col col-1-of-3 col-m-1-of-2">
                                        <a href="'.esc_url( home_url( '/' ) ).'">
                                            <img src="'.get_template_directory_uri().'/images/gallery/men3.jpg" alt="'.__('men','flat-commerce').'"/>
                                            <div class="product-item-wrapper">
                                                <div class="total">
                                                    <a href="#">
                                                        '.__( '24 Collections', 'flat-commerce' ).'
                                    ...
                                    <li class="col col-1-of-3 col-m-1-of-2">
                                        <a href="'.esc_url( home_url( '/' ) ).'">
                                            ...
                                            <div class="product-item-wrapper">
                                                ...
                                                <div class="type-of-product">
                                                    '.__( 'Stich Fashion collection', 'flat-commerce' ).'
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                    ...
                    <div id="tabs-' . intval( $options['product_slider_category'] ) . '">
                        <div class="" id="mens">
                            ...
                            while(  $category_query->have_posts() ){
                                    ...
                                    $flat_commerce_product_category_slider .= '
                                        <li class="col col-1-of-4 col-m-1-of-2" >
                                ...
                                if ( 0 == ( $li_count % 4 ) ) { // insert new ul element if posts_per_page is greater than layout option
                                    $flat_commerce_product_category_slider .= '
                                    </ul><!-- .slides -->
                                    <ul class="slides">';
                                }
